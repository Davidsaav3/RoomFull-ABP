...
@Component({
  selector: 'app-modelo-privado-page',
  templateUrl: './modelo-privado-page.component.html',
  styleUrls: ['./modelo-privado-page.component.css']
})
export class ModeloPrivadoPageComponent implements OnInit {
  ...
  constructor( private usuarioService: UsuarioService, private route: ActivatedRoute, private escenaService:EscenaService, private router: Router, private dataAux: DataService2) {
  ...
  ngOnInit(): void {
   this.obtenerEscena();
   this.dataAux.changeMessage2("privado");
