...
@Component({
	selector: 'app-ui-enlace-infobar-bottom',
	templateUrl: './ui-enlace-infobar-bottom.component.html',
  styleUrls:['ui-enlace-infobar-bottom.component.css']
})
export class UiEnlaceInfobarBottomComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    document.addEventListener("fullscreenchange", () => {
      if (!document.fullscreenElement && mdlWrp) {
