...
@Component({
  selector: 'app-ui-enlace-infobar-top',
  templateUrl: './ui-enlace-infobar-top.component.html',
  styleUrls:['ui-enlace-infobar-top.component.css']

})
  export class UiEnlaceInfobarTopComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      if (this.navUrl === "enlace-modelo"){
        this.esPrivado = true;
        this.obtenerEscenaSinVisitaNoToken();
      }
    ...
    obtenerEscenaSinVisitaNoToken(){
      this.escenaService.cargarEscenaNoToken(this.idmodelo).subscribe({
        next:((res : any)=>{
